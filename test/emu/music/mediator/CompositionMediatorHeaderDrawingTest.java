...
public class CompositionMediatorHeaderDrawingTest {
    @Test
    public void testDrawColumnHeader_Bar() {
        TestDrawer drawer = new TestDrawer();
        CompositionMediator compositionMediator = TestMediatorCreator.newMediator(new Composition(), 0, 0, 300, 224, new TestDrawer());
        compositionMediator.setColumnHeaderUserInput(new TestUserInput(0, 0));
        compositionMediator.setHeaderDrawers(null, drawer);
    ...
    public void testDrawRowHeader() {
        TestDrawer drawer = new TestDrawer();
        CompositionMediator compositionMediator = TestMediatorCreator.newMediator(new Composition(), 0, 0, 300, 100, new TestDrawer());
        compositionMediator.setHeaderDrawers(drawer, null);
    ...
    public void testDrawRowHeader_DrawCOffset() {
        TestDrawer drawer = new TestDrawer();
        CompositionMediator compositionMediator = TestMediatorCreator.newMediator(new Composition(), 0, 8, 300, 100, new TestDrawer());
        compositionMediator.setHeaderDrawers(drawer, null);
        compositionMediator.drawRowHeader();
